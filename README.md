...
### Summary
  1. [Running CLI installer](https://github.com/nnmfnwl/dexsetup.cli.installer#1-running-cli-installer)
  2. [Remote desktop management with VNC](https://github.com/nnmfnwl/dexsetup.cli.installer#2-remote-desktop-management-with-vnc)
  3. [Directory structure](https://github.com/nnmfnwl/dexsetup.cli.installer#3-directory-structure)
  4. [Start, Attach, Navigate and Detach from installed dexsetup environment by terminal](https://github.com/nnmfnwl/dexsetup.cli.installer#4-start-attach-navigate-and-detach-from-installed-dexsetup-environment-by-terminal)
  5. [Using Blocknet(BLOCK) with Litecoin(LTC) dexbot trading strategy 1 generated by installer](https://github.com/nnmfnwl/dexsetup.cli.installer#5-using-blocknetblock-with-litecoinltc-dexbot-trading-strategy-1-generated-by-installer)
     - 5.1.1. [Start and sync Blocknet and Litecoin DEX wallet profiles](https://github.com/nnmfnwl/dexsetup.cli.installer#511-start-and-sync-blocknet-and-litecoin-dex-wallet-profiles)
     - 5.1.2. [Start and sync Blocknet and Litecoin DEX wallet profiles - additional resources](https://github.com/nnmfnwl/dexsetup.cli.installer#512-start-and-sync-blocknet-and-litecoin-dex-wallet-profiles---additional-resources)
     - 5.2.1. [Mandatory finalization and tuning BLOCK/LTC strategy 1](https://github.com/nnmfnwl/dexsetup.cli.installer#521-mandatory-finalization-and-tuning-blockltc-strategy-1)
     - 5.2.2. [Mandatory finalization and tuning BLOCK/LTC strategy 1 - Additional resources](https://github.com/nnmfnwl/dexsetup.cli.installer#522-mandatory-finalization-and-tuning-blockltc-strategy-1---additional-resources)
